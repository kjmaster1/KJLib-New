 ...
 */
public class AutomationFilterItemHandler implements IItemHandlerModifiable, INBTSerializable<ListTag> {

    private final GenericItemHandler wrapped;

    public AutomationFilterItemHandler(GenericItemHandler wrapped) {
