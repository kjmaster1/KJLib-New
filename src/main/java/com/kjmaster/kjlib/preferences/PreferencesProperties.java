...
import com.kjmaster.kjlib.network.PacketSendPreferencesToClient;
...
public class PreferencesProperties {
    ...
    private void syncToClient(ServerPlayer player) {
        KJLib.networkHandler.sendTo(new PacketSendPreferencesToClient(buffStyle, buffX, buffY, style), player.connection.connection, NetworkDirection.PLAY_TO_CLIENT);
        dirty = false;
    }
