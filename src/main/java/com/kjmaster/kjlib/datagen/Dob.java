...
//        }
        ...
        public Builder smelting(Function<SimpleCookingRecipeBuilder, SimpleCookingRecipeBuilder> builder, Ingredient ingredient, float experience, int cookingTime) {
            final Consumer<IRecipeFactory> orig = this.recipe;
            this.recipe = f -> {
                orig.accept(f);
                f.smelting(builder.apply(SimpleCookingRecipeBuilder.smelting(ingredient, RecipeCategory.MISC, getItemLike(), experience, cookingTime)));
            };
            return this;
        }
        ...
        public Builder smelting(String id, Function<SimpleCookingRecipeBuilder, SimpleCookingRecipeBuilder> builder, Ingredient ingredient, float experience, int cookingTime) {
            final Consumer<IRecipeFactory> orig = this.recipe;
            this.recipe = f -> {
                orig.accept(f);
                f.smelting(id, builder.apply(SimpleCookingRecipeBuilder.smelting(ingredient, RecipeCategory.MISC, getItemLike(), experience, cookingTime)));
            };
            return this;
        }
